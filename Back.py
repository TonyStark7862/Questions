...
# Ensure directories exist before initializing logging
...
class ConfigManager:
    ...
    def __init__(self, config_path="config.txt"):
        self.config = {
            ...
            "LOGS_DIR": "./logs",
            "TEMP_DIR": "./temp",
            "EMBEDDING_MODEL_NAME": "all-MiniLM-L6-v2",  # Changed from BAAI/bge-small-en-v1.5
...
class EmbeddingManager:
    ...
    def __init__(self, config_manager):
        ...
        # Store the actual embedding dimension from the model
        self.embedding_dimension = self.model.get_sentence_embedding_dimension()
        logger.info(f"Embedding dimension from model: {self.embedding_dimension}")
...
class QdrantManager:
    ...
    def __init__(self, config_manager, embedding_dimension=None):
        ...
        self.vector_size = embedding_dimension or int(self.config.get("EMBEDDING_MODEL_DIMENSIONS"))
    ...
    def add_chunks(self, processed_doc: ProcessedDocument, embeddings: List[List[float]], 
        ...
        try:
            ...
            # Create points
            points = []
            base_id = int(hashlib.md5(processed_doc.file_id.encode()).hexdigest()[:8], 16)
...
class RAGManager:
    ...
    def __init__(self):
        ...
        # Pass the actual embedding dimension to QdrantManager
        self.qdrant_manager = QdrantManager(self.config_manager, self.embedding_manager.embedding_dimension)
